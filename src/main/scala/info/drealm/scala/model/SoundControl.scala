...
class SoundControl protected[model] (__prgChg: Byte, __prgChgTxmChn: Byte, __bankMSB: Byte, __bankLSB: Byte, __volume: Byte) extends DataItem with Cloneable {
    ...
    protected[model] def this(soundControl: SoundControl) = this(soundControl.prgChg, soundControl.prgChgTxmChn, soundControl.bankMSB, soundControl.bankLSB, soundControl.volume)
